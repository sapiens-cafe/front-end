    ...
    variant === 'simple'
      ...
      : variant === 'outline'
        ...
        : variant === 'primary'
          ...
          : variant === 'muted'
            ? 'bg-[#A26043] relative z-10 hover:bg-neutral-900  border border-transparent text-white text-sm md:text-sm transition font-medium duration-200  rounded-md px-4 py-2  flex items-center justify-center shadow-[0px_1px_0px_0px_#FFFFFF20_inset]'
            : '';
  return (
    <Tag
      className={cn(
